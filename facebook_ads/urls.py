...
from .views import GetTokenView, GetUrlView, SendConversionEventView
from .accounts import (
    ConnectAccountView,
    DetachAccountView,
    GetCredentialsView,
    ListClientsView,
    MetaPixelCredentialsView,
)
...
urlpatterns = [
    ...
    path(
        "meta-pixel/",
        MetaPixelCredentialsView.as_view(),
        name="meta-pixel-credentials",
    ),
    path(
        "send-conversion-event/",
        SendConversionEventView.as_view(),
